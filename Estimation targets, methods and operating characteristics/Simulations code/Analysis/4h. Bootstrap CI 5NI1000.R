...
# Load Simulated Data
load("Simulated Data 1000.RData")
...
for (s in 1:n.scen) {
  ...
  t<-length(x.dur)-1
  while (t>0) {
    if ((formula.1(x.dur[t])+0.05)>max.p) {
      flag=0
...
save.image("Bootstrap CI 5NI1000 - Estimand RD.RData")
